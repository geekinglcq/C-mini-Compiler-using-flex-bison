...
{
       0,    44,    44,    50,    61,    65,    67,    71,    80,    79,
      96,    98,   103,   102,   118,   121,   127,   138,   141,   149,
     148,   158,   173,   185,   188,   200,   203,   205,   207,   209,
     211,   215,   217,   221,   226,   234,   241,   243,   249,   254,
     258,   263,   262,   272,   278,   282,   284,   286,   288,   290,
     292,   296,   302,   306,   308,   312,   318,   322,   324,   328,
     330,   332,   334,   341,   340,   351,   354,   357,   368
};
#endif
...
static const char *const yytname[] =
{
  ...
  "GTEQ", "LT", "GT", "PLUS", "MINUS", "TIMES", "OVER", "LPAREN", "RPAREN",
  "LBRACK", "RBRACK", "LCURL", "RCURL", "SEMI", "COMMA", "$accept",
    ...
    { TreeNode * t = (yyvsp[(1) - (2)].tnode);
			      ...
			      while (t->sibling != NULL)
				    t = (TreeNode *) t->sibling;
                            ...
                            else (yyval.tnode) = (yyvsp[(2) - (2)].tnode);
			  ;}
    break;
...
#line 72 "cmini.y"
    { (yyval.tnode) = (TreeNode *) newNode(VarDeclK);
			    (yyval.tnode)->attr.op = (yyvsp[(1) - (3)].tok);
...
#line 80 "cmini.y"
    { (yyval.tnode) = (TreeNode *) newNode(VarDeclK);
			    (yyval.tnode)->attr.op = (yyvsp[(1) - (4)].tok);
			    (yyval.tnode)->child[0] = (TreeNode *) newNode(IdK);
			    (yyval.tnode)->child[0]->attr.name = (char *) copyString(lastid);
			    printf("\nARRAY VAR: %s\t",lastid);
...
#line 103 "cmini.y"
    { (yyval.tnode) = (TreeNode *) newNode(FunDeclK);
			    (yyval.tnode)->attr.op = (yyvsp[(1) - (2)].tok);
			    (yyval.tnode)->child[0] = (TreeNode *) newNode(IdK);
			    (yyval.tnode)->child[0]->attr.name = (char *) copyString(lastid);
         		    insert_function_record(lastid, scopenum);
			    printf("\nFUNCTION: %s\tRETURN TYPE:%d",lastid,(yyvsp[(1) - (2)].tok));
                            scopenum++;
			   ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 112 "cmini.y"
    { (yyval.tnode) = (yyvsp[(3) - (7)].tnode);
			    (yyval.tnode)->child[1] = (yyvsp[(5) - (7)].tnode);
			    (yyval.tnode)->child[2] = (yyvsp[(7) - (7)].tnode);
      			  ;}
    break;
    ...
    { TreeNode * t = (yyvsp[(1) - (3)].tnode);
			      ...
			      while (t->sibling != NULL)
				    t = (TreeNode *) t->sibling;
                            ...
                            else (yyval.tnode) = (yyvsp[(3) - (3)].tnode);
			  ;}
    break;
...
#line 159 "cmini.y"
    {
			    TreeNode * t = (yyvsp[(2) - (4)].tnode);
                if (t != NULL)
                {
			      while (t->sibling != NULL)
			      	    t = (TreeNode *) t->sibling;
                  t->sibling = (yyvsp[(3) - (4)].tnode);
                  (yyval.tnode) = (yyvsp[(2) - (4)].tnode);
			    }
                else (yyval.tnode) = (yyvsp[(3) - (4)].tnode);
                scopenum--;
			  ;}
    break;
...
#line 222 "cmini.y"
    { (yyval.tnode) = (TreeNode *) newNode(IfK);
			    (yyval.tnode)->child[0] = (yyvsp[(3) - (5)].tnode);
			    (yyval.tnode)->child[1] = (yyvsp[(5) - (5)].tnode);
			  ;}
    break;
...
#line 227 "cmini.y"
    { (yyval.tnode) = (TreeNode *) newNode(IfK);
			    (yyval.tnode)->child[0] = (yyvsp[(3) - (7)].tnode);
			    (yyval.tnode)->child[1] = (yyvsp[(5) - (7)].tnode);
			    (yyval.tnode)->child[2] = (yyvsp[(7) - (7)].tnode);
			  ;}
    break;
...
#line 244 "cmini.y"
    { (yyval.tnode) = (TreeNode *) newNode(ReturnK);
			    (yyval.tnode)->child[0] = (yyvsp[(2) - (3)].tnode);
			  ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 267 "cmini.y"
    { (yyval.tnode) = (yyvsp[(2) - (5)].tnode);
			    (yyval.tnode)->child[0] = (yyvsp[(4) - (5)].tnode);
			  ;}
    break;
...
#line 273 "cmini.y"
    { (yyval.tnode) = (TreeNode *) newNode(OpK);
			    (yyval.tnode)->attr.op = (yyvsp[(2) - (3)].tok);
			    (yyval.tnode)->child[0] = (yyvsp[(1) - (3)].tnode);
			    (yyval.tnode)->child[1] = (yyvsp[(3) - (3)].tnode);
			  ;}
    break;
...
#line 297 "cmini.y"
    { (yyval.tnode) = (TreeNode *) newNode(OpK);
			    (yyval.tnode)->attr.op = (yyvsp[(2) - (3)].tok);
			    (yyval.tnode)->child[0] = (yyvsp[(1) - (3)].tnode);
			    (yyval.tnode)->child[2] = (yyvsp[(3) - (3)].tnode);
			  ;}
    break;
...
#line 346 "cmini.y"
    { (yyval.tnode) = (yyvsp[(2) - (5)].tnode);
			    (yyval.tnode)->child[1] = (yyvsp[(4) - (5)].tnode);
			  ;}
    break;
